...
// 1.0.1 Removed unnecessary processing causing bugs
// 1.1.0 Added state icons to the display content
// 1.1.1 Changed the number of displayed state icon rows from 1 to 2
// ===================================================
/*:en
 * @target MZ
 * @plugindesc MZ exclusive plugin that adds status display effects to skills.
 * @author Artemis
 * @translator IkuSenpai
 *
 * @help ARTM_DispStatusInBattleMZ
 * Plugin that adds status display traits to skills.
 *
 *-------------------------------------------------
 * Memo tags are as follows:
 *-------------------------------------------------
 * ★Add the following tag to any line in the skill's note field:
 *   <RS_RESEARCH:VALID>
 *   ☆With tag: Enabled, Without tag: Disabled
 *
 *-------------------------------------------------
 * Usage Notes
 *-------------------------------------------------
 * ★Skills with the above tag enabled will always target the user.
 *
