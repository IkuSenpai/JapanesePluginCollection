...
(() => {
    'use strict';
    // Disables all functions except during event testing
    ...
    //=============================================================================
    // DataManager
    //  Define additional map loading for testing.
    //=============================================================================
    ...
    //=============================================================================
    // Game_Picture
    //  Interrupts the move when a picture is grabbed.
    //=============================================================================
    ...
    //=============================================================================
    // Game_Screen
    //  Save the coordinates of the last selected picture.
    //=============================================================================
    ...
    Game_Screen.prototype.initialize = function() {
        ...
        this._copyCount    = 0;
        this._infoPicture  = '';
        this._infoHelp     = 'Shift: Window Display Switching Ctrl+Mouse: Snap to grid Ctrl+C: Coordinate Copies ';
        this._infoCopy     = '';
        this._documentTitle = '';
    };
    ...
    Game_Screen.prototype.updatePictures = function() {
        ...
        if (Utils.isNwjs() && Input.isPressed('control') && Input.isTriggered('copy')) {
            ...
            if (this._copyCount % 2 === 0) {
                ...
                this._infoCopy = ' X coordinate[' + copyValue + ']copied.';
            } else {
                copyValue = this._lastPictureY.toString();
                this._infoCopy = ' Y coordinate[' + copyValue + ']copied.';
            }
    ...
    //=============================================================================
    // Scene_Map
    //  Special handling during test events
    //=============================================================================
    ...
    //=============================================================================
    // Spriteset_Base
    //  Find the one you are grabbing from the picture under control.
    //=============================================================================
    ...
    //=============================================================================
    // Sprite_Picture
    //  Grab the picture during the test event.
    //=============================================================================
    ...
    //=============================================================================
    // Sprite_Picture
    //  Common areas that allow touch operation
    //=============================================================================
