...
/*:
 * @target MZ.
 * @plugindesc v1.02 A plugin to enhance the equipment you have.
 * @author ebi.
 * @translator NamiBoops
 * @url http://www.zf.em-net.ne.jp/~ebi-games/
 *
 * @param NextGradeName
 * @desc The display name of the next grade.
 * @default Next:.
 *
 * @param CostName
 * @desc Display name of the cost.
 * @default Cost:.
 *
 * @param UpgradeConfirmText
 * @desc Confirmation text when upgrading equipment.
 * %1 - current equipment %2 - equipment after upgrade
 * @default Do you want to upgrade %1 to %2?
 *
 * @param ConfirmYes
 * @desc The name of the OK in the confirmation window.
 * @default Yes.
 *
 * @param ConfirmNo
 * @desc The name of the confirmation window cancel.
 * @default No
 *
 *
 * @help
 ...
 * ============================================================================
 *
 * If you add the "Next Grade Equipment Tag", "Money Needed", and "Items Needed" to your equipment.
 * You can enhance your equipment in the equipment enhancement menu.
 *
 * ============================================================================
 * Tags.
 * ============================================================================
 *
 * Tags for weapon and armor note fields:.
 * <NextGrade:x>
 * Allows you to upgrade to a weapon (armor) with IDx.
 *
 * <UpgradeCost>
 * item id
 * item id: x
 ...
 * gold: x
 * </UpgradeCost>
 * Set the ID of the item in id and the number of items in x.
 * [Note] If you do not put a space after ":", it will not be recognized correctly.
 *
 * Example.
 * <UpgradeCost>
 * item 1
 ...
 * gold: 300
 * </UpgradeCost>
 * Requires 1 item from ID1, 3 items from ID2, and 300g of money.
 *
 * ============================================================================
 * Plugin Commands.
 * ============================================================================
 *
 * OpenEquipUpgrade.
 * Open the equipment upgrade screen.
 *
 * ============================================================================
 * Update History.
 * ============================================================================
 *
 * Version 1.02
 * Fixed a bug that equipment upgrade would stop with an error message.
 * Fixed a bug that caused the equipment upgrade to stop with an error.
 * Version 1.01
 * Version 1.01
 * Added support for MZ.
 * Version 1.01
 * Version 1.00
 * Fixed a bug that the face grains are not displayed at the first time.
 * Version 0.04
 * Version 0.04
 * Fixed a bug that the face glow is not displayed at the first time.
 * Version 0.03
 * Version 0.03
 * Fixed a bug that the gold designations are not reflected.
 * * Version 0.02
 * Version 0.02
 * Changed so that armor and weapons can be used as materials. Fixed a bug that does not show money when the cost does not cost any money.
 * Changed so that it is not displayed when the cost does not cost money.
 * * Version 0.01
 * Version 0.01
 * Created.
 *
 ...
 * ・Redistribution of only the material is acceptable.
 * ・Use in adult games or cruel games is allowed.
 *
 * @command OpenEquipUpgrade
 * @text Equipment upgrade screen
 * @desc Open the equipment upgrade screen.
 */
...
var line = notedata[i];
if (line.match(note1)) {
var line = notedata[i]; if (line.match(note1)) { gatherIngredients = true;
...
this.addCommand(ConfirmYes, 'confirm'); this;
...
this._statusWindow.setActor(actor); var actor = this;
