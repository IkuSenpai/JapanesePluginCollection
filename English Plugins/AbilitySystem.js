...
// Initialize the save data to account for cases where the save data does not contain information on ability skills.
...
Game_Actor.prototype.changeExp = function(exp, show, opt = { isClassChange: false }) {
    ...
    if (opt.isClassChange) {
        // If the experience change is due to a class change, add the skills you currently have to lastskills.
